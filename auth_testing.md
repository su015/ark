...
Step 2: API Testing
```
curl -c cookies.txt -X POST http://localhost:8001/api/auth/login -H "Content-Type: application/json" -d '{"email":"admin@arketype.studio","password":"arketype-admin-2026"}'
cat cookies.txt
